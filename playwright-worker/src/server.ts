...
import { renderComponent, initBrowser, closeBrowser, RenderOptions, RenderResult } from './renderer.js';
...
fastify.post<{ Body: RenderRequestBody }>('/render', async (request, reply) => {
